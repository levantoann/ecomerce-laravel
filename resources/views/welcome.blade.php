...
<body>
    ...
    $('.add-to-cart').click(function() {
        ...
        var cart_product_id = $('.cart_product_id_' + id).val(); // Lấy giá trị từ trường ẩn
        var cart_product_name = $('.cart_product_name_' + id).val(); // Lấy giá trị từ trường ẩn
        var cart_product_image = $('.cart_product_image_' + id).val(); // Lấy giá trị từ trường ẩn
        var cart_product_price = $('.cart_product_price_' + id).val(); // Lấy giá trị từ trường ẩn
        var cart_product_qty = $('.cart_product_qty_' + id).val(); // Lấy giá trị từ trường ẩn
