      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody id="category_order">
          ...
          <tr id="{{$cate_pro->category_id}}">
            ...
            <td>
              <a href="{{URL::to('/edit-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class=""><i class="fa fa-pencil-square-o text-success text-active"></i>
              </a>
